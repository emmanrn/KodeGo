...
public class SpriteLoaderEditor : EditorWindow
{
    ...
    private CharacterConfig_SO characterConfigFile;
    ...
    private void OnGUI()
    {
        ...
        characterConfigFile = (CharacterConfig_SO)EditorGUILayout.ObjectField("Character Config:", characterConfigFile, typeof(CharacterConfig_SO), false);
